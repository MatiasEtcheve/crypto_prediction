...
class auto_encoder(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv1d(
            ...
            self.kernel_size_1,
            stride=1,
            padding=int((self.kernel_size_1 - 1) / 2),
        )
        ...
        self.conv2 = nn.Conv1d(
            ...
            self.kernel_size_2,
            stride=1,
            padding=int((self.kernel_size_2 - 1) / 2),
        )
        ...
        self.conv3 = nn.Conv1d(
            ...
            self.kernel_size_3,
            stride=1,
            padding=int((self.kernel_size_3 - 1) / 2),
        )
        ...
        self.pool = nn.MaxPool1d(
            kernel_size=self.maxpool_kernel_size, stride=self.max_pool_stride
        )
